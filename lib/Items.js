...
class Articles {
    ...
    static getItems( callback ) {
        var url = "http://api.bestbuy.com/v1/products(longDescription=iPhone*%7Csku=7619002)?show=sku,name,salePrice,largeImage,categoryPath,upc&pageSize=100&page=5&apiKey=f4crwde3ysnxw655jrvyp32e&format=json";
